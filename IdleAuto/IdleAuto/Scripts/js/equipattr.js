(function () {
    ...
    const tipRules = [
        ...
        { name: "增强伤害", regexp: /^\+(\d+)\% 增强伤害$/, format: a => `${a}增伤`, style: "physical", default: true },
        { name: "防御", regexp: /^\+(\d+)\% 防御$/, format: a => `${a}防御`, style: "physical", default: true },
        { name: "攻击速度", regexp: /^攻击速度提升 (\d+)\%/, format: a => `${a}攻速`, style: "physical", default: true },
        { name: "施法速度", regexp: /^施法速度提升 (\d+)\%/, format: a => `${a}释放`, style: "magic", default: true },
        { name: "魔法装备", regexp: /^\+(\d+)\% 更佳的机会取得魔法装备/, format: a => `${a}装备`, style: "state", default: true },
        { name: "额外金币", regexp: /^\+(\d+)\% 额外金币从怪物身上取得/, format: a => `${a}金币`, style: "lightning", default: true },
        { name: "元素抗性", regexp: /^元素抗性 \+(\d+)\%/, format: a => `${a}抗性`, style: "skill", default: true },
        { name: "抗火", regexp: /^抗火 \+(\d+)/, format: a => `${a}抗火`, style: "fire", default: true },
        { name: "抗寒", regexp: /^抗寒 \+(\d+)/, format: a => `${a}抗寒`, style: "cold", default: true },
        { name: "抗闪电", regexp: /^抗闪电 \+(\d+)/, format: a => `${a}抗电`, style: "lightning", default: true },
        { name: "抗毒", regexp: /^抗毒 \+(\d+)/, format: a => `${a}抗毒`, style: "poison", default: true },
        ...
        { name: "掉落等级", regexp: /^掉落等级：(\d+)/, format: a => `掉落${a}`, style: "", default: false },
        { name: "需要等级", regexp: /^需要等级：(\d+)/, format: a => `需要${a}`, style: "", default: false },
